...
/**
* @brief				Функція myStrncpy() використовуєтья для копіювання
*               " num " перших символів рядка str2 у рядок str1.
* @param	[in]		str1 Вказівник на рядок, куди буде скопійовано рядок str2
...
/**
* @brief				Функція myStrnccat() використовується для додавання
*                 " num " перших символів рядка str2 до рядка str1.
